...
Public.gotoDetailItem = function(params){
	...
	var urls = {
		//SALE
		'150601' : {tabid : 'sales-sales',text : '销货单',right:'SA_QUERY', url : '../sales/index?id='},
		//SALEBACK
		'150602' : {tabid : 'sales-salesBack',text : '销货退货单',right:'SA_QUERY', url : '../sales/index?transType=150602&id='},
		//PUR
		'150501' : {tabid : 'purchase-purchase',text : '购货单',right:'PU_QUERY',url : '../purchase/index?id='},
		//PUR
		'150502' : {tabid : 'purchase-purchaseBack',text : '购货退货单',right:'PU_QUERY',url : '../purchase/index?transType=150502&id='},
		//TRANSFER
		'103091' : {tabid : 'storage-transfers',text : '调拨单',right:'TF_QUERY',url : '../storage/transfers?id='},
		//OO
		'150806' : {tabid : 'storage-otherOutbound',text : '其它出库 ',right:'OO_QUERY',url : '../storage/other_outbound?id='},
		//OI
		'150706' : {tabid : 'storage-otherWarehouse',text : '其它入库 ',right:'IO_QUERY',url : '../storage/other_warehouse?id='},
		//OO
		'150801' : {tabid : 'storage-otherOutbound',text : '盘亏',right:'OO_QUERY',url : '../storage/other_outbound?id='},
		//OI
		'150701' : {tabid : 'storage-otherWarehouse',text : '盘盈',right:'IO_QUERY',url : '../storage/other_warehouse?id='},
		//CADJ
		'150807' : {tabid : 'storage-adjustment',text : '成本调整',right:'CADJ_QUERY',url : '../storage/adjustment?id='},
		//PAYMENT
		'153101' : {tabid : 'money-payment',text : '付款单',right:'PAYMENT_QUERY',url : '../money/payment?id='},
		//RECEIPT
		'153001' : {tabid : 'money-receipt',text : '收款单',right:'RECEIPT_QUERY',url : '../money/receipt?id='},
		//PAYMENT
		'153301' : {tabid : 'storage-assemble',text : '组装单',right:'ZZD_QUERY',url : '../storage/assemble?id='},
		//RECEIPT
		'153302' : {tabid : 'storage-disassemble',text : '拆卸单',right:'CXD_QUERY',url : '../storage/disassemble?id='}

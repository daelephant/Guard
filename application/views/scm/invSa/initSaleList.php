...
="ui-btn ui-btn-refresh" id="refresh" title="刷新"><b></b></a>--></li>
    ...
    <a class="ui-btn" id="print" target="_blank"
 href="javascript:void(0);">打印</a><!-- a class="ui-btn" id="import" target="_blank" href="javascript
:void(0);">导入</a-->
<!-- <a class="ui-btn" id="export" target="_blank" href="javascript:void(0);">导出</a><a
 class="ui-btn dn" id="audit">审核</a><a class="ui-btn" id="reAudit">反审核</a> -->
 </div>
  </div>

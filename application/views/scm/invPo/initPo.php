...
var isAdmin = <?php echo $this->common_model->isAdmin(221) ? 'true' : 'false'?>; //是否管理员
  ...
  <div class="bills cf">
    <div class="con-header">
      <dl class="cf">
        ...
        <dd class="pct20 tc">
          <label>单据日期:</label>
          <input type="text" id="date" class="ui-input ui-datepicker-input" value="2015-10-23">
        </dd>
        <dd class="pct20 tc">
          <label>交货日期:</label>
          <input type="text" id="deliveryDate" class="ui-input ui-datepicker-input" value="2015-10-23">
        </dd>
...
<script src="<?php echo base_url()?>statics/js/dist/purchaseOrder.js?ver=201510141132"></script>
</body>
</html>
